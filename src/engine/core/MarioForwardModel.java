...
public class MarioForwardModel {
        ...
        switch (detail) {
            ...
            case (1):
                switch (tile) {
                    ...
                    case 48:
                    case 49:
                        // body for jump-through platform
                    case 47:
                        return OBS_NONE;
                    // solid blocks
                    case 1:
     ...
     */
    public int[][] getScreenCompleteObservation(int i, int i1) {
     ...
     * @return 2D grid that have all the information about all objects on the screen
     */
    public int[][] getMarioCompleteObservation(int i, int i1) {
    ...
    public int getMarioScreenTileX() {
        return (int) ((this.world.mario.x - this.world.cameraX) / 16);
    }

    public int getMarioScreenTileY() {
        return (int) (this.world.mario.y / 16);
    }

    public int getBlockValue(int x, int y) {
        return this.world.level.getBlock(x, y);
    }
}
